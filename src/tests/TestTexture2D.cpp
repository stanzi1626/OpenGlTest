...
namespace test {
        ...
        m_View(glm::translate(glm::mat4(1.0f), glm::vec3(0, 0, 0)))
    {
        ...
        m_Shader = std::make_unique<Shader>("/Users/alexstansfield/Desktop/Programmes/OpenGlTest/res/shaders/basic.shader");
        m_Shader->Bind();
        m_Texture = std::make_unique<Texture>("/Users/alexstansfield/Desktop/Programmes/OpenGlTest/Image.png");
